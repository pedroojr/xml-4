...
export const ExportOptions: React.FC<ExportOptionsProps> = ({ 
  ...
  const [exportFields, setExportFields] = useState<ExportField[]>([
    ...
    { id: 'uom', label: 'Unidade', checked: true },
    { id: 'quantity', label: 'Quantidade', checked: true },
    { id: 'unitPrice', label: 'Preço Unitário', checked: true },
    { id: 'totalPrice', label: 'Preço Total', checked: true },
